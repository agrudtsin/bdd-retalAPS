...
Сценарий: UC7-2. Один заказ фикс. кво уменьшение
	...
	И закрываю текущее окно без сохранения изменений
		...
		И     я нажимаю на кнопку "Да"
#
Сценарий: UC7-3. Два заказа фикс. кво уменьшение 2-го заказа
	####		| 'Объект'                                       | 18.01 | 19.01 | 20.01 | 21.01 |
...
#
Сценарий: UC7-4. Два заказа фикс. кво уменьшение 1-го заказа
	####		| 'Объект'                                       | 18.01 | 19.01 | 20.01 | 21.01 |
	# Дано		| '25,5.38MM3.93.МБЕЛ_100.60.САМ.10320.С'        | '39'  | '29'  | '00'  | '00'  |
	#			| '25,5.38MM3.93.БСЦ_000.00.САМ.М10.10320.С2.МБ' | '00'  | '10'  | '39'  | '39'  |
	...
	Когда открываю тестовый документ №000000160 с тестовой ситуацией
#
Сценарий: UC7-7. Три заказа фикс. кво увеличение 1-го заказа
#
Сценарий: UC7-8. Три заказа фикс. кво увеличение 2-го заказа
#
Сценарий: UC7-7. Три заказа фикс. кво увеличение 1-го заказа
#
Сценарий: UC7-8. Три заказа фикс. кво увеличение 2-го заказа
