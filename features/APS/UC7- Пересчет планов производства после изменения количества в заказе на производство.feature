...
Сценарий: UC7-3. Два заказа / фикс. количество / уменьшение 2-го заказа
	...
	Когда открываю тестовый документ №000000160 с тестовой ситуацией
		Когда В панели разделов я выбираю "Планирование производства (APS)"
		И     В панели функций я выбираю "План производства (с редактированием)"
		И     я нажимаю кнопку выбора у поля "Документ планирования"
		Тогда открылось окно "План производства"
		...
		И     я нажимаю на кнопку "Найти..."
		Тогда открылось окно "Найти"
		И     в поле "&Что искать" я ввожу текст "000000160"
		И     я меняю значение переключателя "Как искать" на ""
		И     я нажимаю на кнопку "&Найти"
		Тогда открылось окно "План производства"
		И     в ТЧ "Список" я активизирую поле "Период c"
		И     В форме "План производства" в ТЧ "Список" я выбираю текущую строку
		И     я нажимаю на кнопку с именем "ФормаКомандаСформироватьОтчет"
		Тогда открылось окно "№000000160 *"


	И уменьшаю количеество 2 го задания на производство на 40ящ (-39 -1) 
		Когда открылось окно "№000000160 *"
		И     я перехожу к закладке "Данные"
		И     я перехожу к закладке "Технологические операции"
		И     В форме "№000000160 за период с * по * ПФ Самара: * (План производства)" в таблице "ТехнологическиеОперации" я перехожу к строке:
		| 'Рабочий центр' | '№' | 'ячОбъект'                              | 'Объект'                                | 'Период'     | 'Интервал по'        | 'Количество'  | 'Порядок' | '№ цепи' | 'Интервал с'         | 'Комплект переналадок'               |
		| 'САМ.Husky.1'   | '7' | '25,5.38MM3.93.МБЕЛ_100.60.САМ.10320.С' | '25,5.38MM3.93.МБЕЛ_100.60.САМ.10320.С' | '21.01.2017' | '22.01.2017 7:59:59' | '402 480,000' | '1'       | '5'      | '21.01.2017 8:00:00' | '25.5 Bericap 38mm3 ▪ [60] ▪ 609149' |
		И     в ТЧ "ТехнологическиеОперации" я активизирую поле "Количество"
		И     В форме "№000000160 за период с * по * ПФ Самара: * (План производства)" в ТЧ "ТехнологическиеОперации" я выбираю текущую строку
		И     в ТЧ "ТехнологическиеОперации" в поле "Количество" я ввожу текст "0,000" 
		И     В форме "№000000160 за период с * по * ПФ Самара: * (План производства)" в таблице "ТехнологическиеОперации" я перехожу к строке:
		| 'Рабочий центр' | '№' | 'ячОбъект'                              | 'Объект'                                | 'Период'     | 'Интервал по'        | 'Количество'  | 'Порядок' | '№ цепи' | 'Интервал с'         | 'Комплект переналадок'               |
		| 'САМ.Husky.1'   | '7' | '25,5.38MM3.93.МБЕЛ_100.60.САМ.10320.С' | '25,5.38MM3.93.МБЕЛ_100.60.САМ.10320.С' | '20.01.2017' | '21.01.2017 7:59:59' | '402 480,000' | '1'       | '4'      | '20.01.2017 8:00:00' | '25.5 Bericap 38mm3 ▪ [60] ▪ 609149' |
		И     В форме "№000000160 за период с * по * ПФ Самара: * (План производства)" в ТЧ "ТехнологическиеОперации" я выбираю текущую строку
		И     в ТЧ "ТехнологическиеОперации" в поле "Количество" я ввожу текст "392 160,000"
		И     В форме "№000000160 за период с * по * ПФ Самара: * (План производства)" в ТЧ "ТехнологическиеОперации" я завершаю редактирование строки
	И пресчитываю план производства
		И     я нажимаю на кнопку с именем "ФормаКомандаСформироватьОтчет"
		И     я нажимаю на кнопку "Выделить весь отчет"
		И     я нажимаю на кнопку "К"
	Тогда провееряю, что изменился график производства 2-го заказа. Уменьшился с 3х до 2-х дней
		И     табличный документ формы с именем "Результат" стал равен:
		| 'Рабочий центр'                      | ''             | ''             | ''                                         | '18.01 Ср 2017' | '19.01 Чт 2017' | '20.01 Пт 2017' | '21.01 Сб 2017' | '22.01 Вс 2017' |
		| 'Рабочий центр'                      | ''             | ''             | ''                                         | 'План'          | 'План'          | 'План'          | 'План'          | 'План'          |
		| 'Рабочий центр'                      | ''             | ''             | ''                                         | ''              | ''              | ''              | ''              | ''              |
...
Сценарий: UC7-4. Два заказа / фикс. количество / уменьшение 1-го заказа
	...
	Когда открываю тестовый документ №000000161 с тестовой ситуацией
		Когда В панели разделов я выбираю "Планирование производства (APS)"
		И     В панели функций я выбираю "План производства (с редактированием)"
		И     я нажимаю кнопку выбора у поля "Документ планирования"
		Тогда открылось окно "План производства"
		...
		И     я нажимаю на кнопку "Найти..."
		Тогда открылось окно "Найти"
		И     в поле "&Что искать" я ввожу текст "000000161"
		И     я меняю значение переключателя "Как искать" на ""
		И     я нажимаю на кнопку "&Найти"
		Тогда открылось окно "План производства"
		И     в ТЧ "Список" я активизирую поле "Период c"
		И     В форме "План производства" в ТЧ "Список" я выбираю текущую строку
		И     я нажимаю на кнопку с именем "ФормаКомандаСформироватьОтчет"
		Тогда открылось окно "№000000161 *"
	И уменьшаю количеество первого задания на производство на 30ящ (-29 -1) 
		Когда открылось окно "№000000161 за период с * по * ПФ Самара: * (План производства)"
		И     я перехожу к закладке "Данные"
		И     я перехожу к закладке "Технологические операции"
		И     В форме "№000000161 за период с * по * ПФ Самара: * (План производства)" в таблице "ТехнологическиеОперации" я перехожу к строке:
		| 'Рабочий центр' | '№' | 'ячОбъект'                                 | 'Объект'                                   | 'Период'     | 'Интервал по'        | 'Количество'  | 'Порядок' | '№ цепи' | 'Интервал с'         | 'Комплект переналадок'               |
		| 'САМ.Husky.1'   | '6' | '25,5.38MM3.93.БСЦ_000.00.САМ.М10.10320.С' | '25,5.38MM3.93.БСЦ_000.00.САМ.М10.10320.С' | '19.01.2017' | '20.01.2017 1:50:45' | '299 280,000' | '1'       | '2'      | '19.01.2017 8:00:00' | '25.5 Bericap 38mm3 ▪ [60] ▪ 609149' |
		И     В форме "№000000161 за период с * по * ПФ Самара: * (План производства)" в таблице "ТехнологическиеОперации" я перехожу к строке:
		| 'Рабочий центр' | '№' | 'ячОбъект'                                 | 'Объект'                                   | 'Период'     | 'Интервал по'        | 'Количество'  | 'Порядок' | '№ цепи' | 'Интервал с'         | 'Комплект переналадок'               |
		| 'САМ.Husky.1'   | '6' | '25,5.38MM3.93.БСЦ_000.00.САМ.М10.10320.С' | '25,5.38MM3.93.БСЦ_000.00.САМ.М10.10320.С' | '18.01.2017' | '19.01.2017 7:59:59' | '402 480,000' | '2'       | '1'      | '18.01.2017 8:00:00' | '25.5 Bericap 38mm3 ▪ [60] ▪ 609149' |
		И     В форме "№000000161 за период с * по * ПФ Самара: * (План производства)" в ТЧ "ТехнологическиеОперации" я выбираю текущую строку
		И     в ТЧ "ТехнологическиеОперации" в поле "Количество" я ввожу текст "392 160,000"
		И     В форме "№000000161 за период с * по * ПФ Самара: * (План производства)" в ТЧ "ТехнологическиеОперации" я выбираю текущую строку
		И     в ТЧ "ТехнологическиеОперации" в поле "Количество" я ввожу текст "0,000"
		И     В форме "№000000161 за период с * по * ПФ Самара: * (План производства)" в ТЧ "ТехнологическиеОперации" я завершаю редактирование строки
	И пресчитываю план производства
		И     я нажимаю на кнопку с именем "ФормаКомандаСформироватьОтчет"
		И     я нажимаю на кнопку "Выделить весь отчет"
		И     я нажимаю на кнопку "К"
	Тогда провееряю, что изменился график производства
		И     табличный документ формы с именем "Результат" стал равен:
		| 'Рабочий центр'                      | ''             | ''             | ''                                         | '18.01 Ср 2017' | '19.01 Чт 2017' | '20.01 Пт 2017' | '21.01 Сб 2017' | '22.01 Вс 2017' |
		| 'Рабочий центр'                      | ''             | ''             | ''                                         | 'План'          | 'План'          | 'План'          | 'План'          | 'План'          |
		| 'Рабочий центр'                      | ''             | ''             | ''                                         | ''              | ''              | ''              | ''              | ''              |
